...
test.describe('Authentication', () => {
  test('login page loads correctly', async ({ page }) => {
    ...
    await page.waitForSelector('#login-email-input', { timeout: 15000 });
  ...
  test('register page loads and navigates back to login', async ({ page }) => {
    ...
    await page.waitForSelector('#reg-business-name', { timeout: 15000 });
  ...
  test('logout via header button', async ({ authenticatedPage: page }) => {
